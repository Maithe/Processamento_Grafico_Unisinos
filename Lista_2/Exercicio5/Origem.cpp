...
int setupGeometry();
void drawCall(GLint rCL, Shader s, GLuint vao);//Função criada com a draw call do exercício para facilitar reutilização
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		drawCall(rasterCodeLoc, shader, VAO);//Função criada com a draw call do exercício para facilitar reutilização
		//////////////////////////////////////////////////////////////
